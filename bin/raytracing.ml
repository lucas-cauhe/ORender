...
let my_scene : scene = List.init 100000 (fun _ -> plane (Direction.from_coords 1. 1. 1.) (Point.from_coords 3. 0. 0.))
...
let () = match find_closest_figure (my_scene @ [plane (Direction.from_coords 1. 1. 1.) (Point.from_coords 0.5 0. 0.)]) !ray with
