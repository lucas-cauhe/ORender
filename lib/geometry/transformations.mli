...
val translation_transformation_of_values : float -> float -> float -> Matrix.matrix_t
...
val cb_transformation_of_base : Direction.direction_t -> Direction.direction_t -> Direction.direction_t -> Point.point_t -> Matrix.matrix_t
