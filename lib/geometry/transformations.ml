  ...
  type hc = Point of Point.point_t | Direction of Direction.direction_t
  type axis = X | Y | Z
  ...
  | _ -> None
  let translation_transformation_of_values tx ty tz = Matrix.from_array_matrix [|
    [| 1.; 0.; 0.; tx |];
    [| 0.; 1.; 0.; ty |];
    [| 0.; 0.; 1.; tz |];
    [| 0.; 0.; 0.; 1. |];
  ...
  let scale_transformation_of_values tx ty tz = Matrix.from_array_matrix [|
    [| tx; 0.; 0.; 0. |];
    [| 0.; ty; 0.; 0. |];
    [| 0.; 0.; tz; 0. |];
    [| 0.; 0.; 0.; 1. |];
